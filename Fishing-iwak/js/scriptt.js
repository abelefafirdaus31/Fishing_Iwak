window.onload = function() {
    ...
    var days = [{
        ...
        "Stage": 1,
        "score": 30,
        "instruction": "Hari pertama di laut, kamu terkejut menemui hiu.<br>Hati-hati, mereka berbahaya!"
    },{
        "Stage": 2,
        "score": 35,
        "instruction": "Sampah mulai bermunculan di laut.<br>Jaga agar sampah tidak mengganggu perburuan ikanmu."
    },{
        "Stage": 3,
        "score": 40,
        "instruction": "Lanjutkan perburuanmu di laut, waspadalah terhadap hiu yang mungkin berada di sekitarmu."
    },{
        "day": 4,
        "score": 45,
    ...
    function createItems() {
        ...
        switch (day) {
            ...
            case 5:
                ...
                createFishInterval = setInterval(createFish, 6000);
                createTrashInterval = setInterval(createTrash, 1500);
                createTrashInterval = setInterval(createTrash, 1500);
                createBelutlistrikInterval = setInterval(createBelutlistrik,2000);
                createBelutlistrikInterval = setInterval(createBelutlistrik,2000);
        ...
        if (!died) {
            ...
            if (day < 5) {
                if (currentScore<=days[day-1].score){
                    instructions.innerHTML = `<h2>END OF DAY 0${day}</h2>Target anda tidak tercapai: ${currentScore}</p><p>Your score is not high enough. Please try again!</p>`;
                    day=0;
                }
                else {
