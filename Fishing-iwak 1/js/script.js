window.onload = function() {
    ...
    var days = [{
        "Stage": 0,
        "score": 20,
        "instruction": "Selamat datang di game edukasi ikan-ikan di Kalimantan.<hr><br>Setiap stage berisi 5 hari permainan.<br>Ada 2 stage: rawa dan laut.<br>Sekarang kamu berada di stage rawa"
    },{
        "Stage": 1,
        "score": 30,
        "instruction": "Hari pertama di rawa, kamu terkejut menemui buaya.<br>Mereka berbahaya! <hr><br> Nama umum: Gabus <br> Nama ilmiah: Channa striata <br>Manfaat ikan:<br> Tulang ikan gabus bisa diolah menjadi tepung tulang kaya kalsium yang berguna sebagai tambahan makanan.<br> Tepung tulang dapat digunakan dalam produk pangan lain. "
    },{
        "Stage": 2,
        "score": 35,
        "instruction": "Sampah mulai bermunculan di rawa.<br>Buaya tidak mendekati tempat yang tercemar sampah.<hr><br>Hindari sampah. <br> Nama umum: Sepat Siam <br> Nama ilmiah: Trichogaster pectoralis <br> Manfaat Ikan Sepat Siam:<br> Trichopodus pectoralis, atau ikan sepat siam, adalah ikan potensial untuk budidaya ekonomis karena nilai ekonomisnya tinggi dan produksinya besar "
    },{
        "Stage": 3,
        "score": 35,
        "instruction":"Hati-hati dengan buaya.<br>Jaga agar sampah tidak mengganggu perburuan ikanmu! <hr><br> Nama umum: Kapar <br> Nama ilmiah: Belontia hasselti <br> Manfaat Ikan kapar: <br> memiliki nilai ekonomis, dijual seharga Rp 40.000 – Rp 60.000 per kilogram. Selain untuk konsumsi, ikan ini juga diperdagangkan sebagai ikan hias." 
    },{
        "day": 4,
        "score": 35,
        "instruction": "Pada hari ini, kita akan membersihkan habitat ikan lele dari sampah untuk menjaga kelangsungan hidup mereka.<br>Jaga lingkungan agar ikan-ikan bisa hidup dengan baik. <hr><br> Nama umum: Lele <br> Nama ilmiah: Clarias spp <br> Manfaat Ikan Lele: <br> Lele adalah sumber protein hewani rendah lemak, kaya vitamin dan mineral, baik untuk kesehatan. Secara ekonomi, budidaya lele menguntungkan petani karena biaya produksi rendah dan pasarnya luas."
    }];
    ...
    function createItems() {
        ...
        switch (day) {
            ...
            case 2:
                createFish1Interval = setInterval(createFish1, 250);
                createTrashInterval = setInterval(createTrash, 1000);
                break;
            case 3:
            ...
            case 5:
                ...
                createRareFishInterval = setInterval(createRareFish, 2800);
    ...
    function endDay(died) {
        ...
        if (!died) {
            ...
            if (day < 5) {
                ...
                instructions.innerHTML = `<h1>Kamu menangkap ikan langka yaitu :<br><hr><br> Nama umum: Belida <br> Nama ilmiah: Chitala lopis. <br>Manfaat ikan belida:<br> ikan Belida digunakan sebagai bahan baku untuk makanan khas seperti empek-empek, kerupuk, kemplang, dan makanan lainnya. Di Provinsi Jambi, ikan ini dianggap sebagai ikan unggulan yang banyak ditemukan di aliran Sungai Batang Hari dan anak sungainya seperti Sungai Batang Tebo, Batang Tabir, dan Batang Tembesi. <br> <h2>Kamu sudah puas dengan hasil tangkapan mu, kamu mendapatkan banyak ikan-ikan yang sangat bermanfaat dan kamu menjadi tahu nama-nama ikan baru!</h2><p>Dari hasil tangkapan, ${fishTracker[0]} ikan-ikan, ${fishTracker[1]} ikan langka, ${fishTracker[2]} sampah dan ${fishTracker[2]} belut listrik.<br>Total Target Kamu: ${score}</p>`;
                day=0;
            }
