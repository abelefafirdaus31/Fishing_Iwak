window.onload = function() {
    ...
    var days = [{
        "Stage": 0,
        "score": 20,
        "instruction": "Selamat datang di game edukasi ikan-ikan di Kalimantan.<br>Setiap stage berisi 5 hari permainan.<br>Ada 2 stage: rawa dan laut.<br>Sekarang kamu berada di stage laut"
    },{
        "Stage": 1,
        "score": 30,
        "instruction": "Hari pertama di laut, kamu terkejut menemui hiu.<br>Hati-hati, mereka berbahaya!<hr><br> Nama umum: Kakap <br> Nama ilmiah: Lutjanus spp. <br>Manfaat ikan kakap:<br> Kakap merah kaya akan vitamin, terutama vitamin A yang baik untuk kesehatan mata, serta kalsium yang menjaga kesehatan tulang dan mencegah osteoporosis."
    },{
        "Stage": 2,
        "score": 35,
        "instruction": "Sampah mulai bermunculan di laut.<br>Jaga agar sampah tidak mengganggu perburuan ikanmu.<hr><br> Nama umum: Kerapu <br> Nama ilmiah: Epinephelus spp. <br>Manfaat ikan kerapu:<br> Ikan kerapu cantang sangat berharga secara ekonomi dan kesehatan. Dibudidayakan untuk pasar domestik dan internasional, memberikan manfaat besar bagi nelayan dan kesehatan konsumen."
    },{
        "Stage": 3,
        "score": 40,
        "instruction": "Lanjutkan perburuanmu di laut, waspadalah terhadap hiu yang mungkin berada di sekitarmu.<hr><br> Nama umum: Barakuda <br> Nama ilmiah: Sphyraena spp. <br>Manfaat ikan barakuda:<br> Meskipun tidak dianggap bernilai komersial di Amerika Utara, barakuda besar adalah target favorit beberapa pemancing karena kemampuannya bertarung. Mereka dapat ditangkap menggunakan berbagai peralatan seperti pancing ulur, pancing dan gulungan, pukat, jaring trammel, dan jaring insang."
    },{
        "day": 4,
        "score": 45,
        "instruction": "Hari ini, kita akan membersihkan habitat ikan tenggiri dari sampah untuk menjaga kelangsungan hidup mereka.<br>Jaga lingkungan agar ikan-ikan bisa hidup dengan baik.<hr><br> Nama umum: Tenggiri <br> Nama ilmiah: Scomberomorus spp. <br>Manfaat ikan tenggiri:<br> Ikan tenggiri adalah produk perikanan penting di Indonesia, terutama di Indonesia Timur. Dagingnya lezat dan teksturnya bagus, sering digunakan untuk membuat pempek dan otak-otak."
    }];
    ...
    function createItems() {
        ...
        switch (day) {
            ...
            case 2:
                createFish1Interval = setInterval(createFish2, 250);
                createTrashInterval = setInterval(createTrash, 1000);
                break;

            case 3:
                createFish2Interval = setInterval(createFish3, 250);
                createTrashInterval = setInterval(createTrash, 1000);
                createTrashInterval = setInterval(createTrash, 1000);
                break;

            case 4:
                createFish3Interval = setInterval(createFish4, 250);
    ...
    function endDay(died) {
        ...
        if (!died) {
            ...
            if (day < 5) {
                ...
                instructions.innerHTML = `<h1>Kamu menangkap ikan langka yaitu :<br><hr><br> Nama umum: Napoleon <br> Nama ilmiah: Cheilinus undulatus. <br>Manfaat ikan Napoleon:<br> Napoleon bernilai tinggi di pasar Asia, mendukung nelayan lokal dan pariwisata bahari. Dagingnya kaya protein, vitamin, mineral, dan rendah lemak, baik untuk kesehatan manusia. <br> <h2>Kamu sudah puas dengan hasil tangkapan mu, kamu mendapatkan banyak ikan-ikan yang sangat bermanfaat dan kamu menjadi tahu nama-nama ikan baru!</h2><p>Dari hasil tangkapan, ${fishTracker[0]} ikan-ikan, ${fishTracker[1]} ikan langka, ${fishTracker[2]} sampah dan ${fishTracker[2]} belut listrik.<br>Total Target Kamu: ${score}</p>`;
                day=0;
            }
            ...
            day = 0;
            instructions.innerHTML = `<h2>Yasudah mancing ulang lagi!!</h2><p>Hiu menyerang kamu, kapal kamu berakhir dihacurkan oleh hiu.<br>Hasil mancing kamu menjadi sia-sia!</p>`;
        }
